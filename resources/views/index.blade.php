...
@section('content')
            ...
            <div class="col-md-4 col-sm-6 margin20">
                <div class="s-feature-box text-center wow animated fadeIn" data-wow-duration="700ms" data-wow-delay="200ms">
                    ...
                    <div class="mask-bottom">
                        ...
                        <h4>LÀM MỘT PHƯỢT THỦ</h4>
                        <!-- Text -->
                        <p>Tự do đi bụi với bản đồ du lịch toàn Việt Nam</p>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-sm-6 margin20">
                <div class="s-feature-box text-center wow animated fadeIn" data-wow-duration="700ms" data-wow-delay="300ms">
                    ...
                    <div class="mask-bottom">
                        ...
                        <h4>LÀM MỘT NHIẾP ẢNH GIA</h4>
                        <!-- Text -->
                        <p>Lưu trữ ảnh và chia sẻ với cộng đồng</p>
                    </div>
                </div>
            </div><!--services col-->
            <div class="col-md-4 col-sm-6 margin20">
                <div class="s-feature-box text-center wow animated fadeIn" data-wow-duration="700ms" data-wow-delay="400ms">
                    ...
                    <div class="mask-bottom">
                        ...
                        <h4>LÀM MỘT BLOGGER</h4>
                        <!-- Text -->
                        <p>Viết lách, chém gió về những cảm xúc trên đường đi</p>
                    </div>
                </div>
            </div><!--services col-->
        </div>
    ...
    <div class="our-team-v-2" style="background: none;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="center-heading">
